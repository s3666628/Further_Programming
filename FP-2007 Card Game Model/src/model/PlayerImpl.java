...
//	java.lang.String id, java.lang.String name, int points)
	...
	public int getTotalPoints() {
		...
		//Hint: If the player doesn't have a current bet this method should return the current points, 
		...
		else {totalPoints = totalPoints; // + amount of the current bet
			return totalPoints;}
	...
	public void assignBet(Bet bet) {
		//get the bet that has been passed in and assign it bet variable which is stored here
		this.bet = bet;
	...
	@Override
	public Hand getHand() {
		// think this is correct returns hand from variable which is stored in this class
		return this.hand;
	}
